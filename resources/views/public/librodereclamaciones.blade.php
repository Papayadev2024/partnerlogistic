...
@section('content')
  <section class="w-11/12 mx-auto font-inter">
    @if ($errors->has('g-recaptcha-response'))
      <span class="help-block">
        <strong>{{ $errors->first('g-recaptcha-response') }}</strong>
      </span>
    @endif
    <h2 class="col-span-4 font-bold text-4xl leading-none md:leading-tight text-center text-[#00557B] pt-3">Libro de Reclamaciones</h2>
    <form class="flex flex-col gap-5" id="formLibroReclamo" action="" method="POST" enctype='multipart/form-data'>
      <div class=" my-16 grid grid-cols-1  lg:grid-cols-4 gap-5 justify-center items-center">
        ...
        <h2 class="col-span-4 font-semibold text-[24px] text-[#00557B] leading-none md:leading-tight">Identificación del Consumidor
        </h2>
        ...
        <h2 class="col-span-4 font-semibold text-[24px] leading-none md:leading-tight text-[#00557B]">Identificación del bien
          contratado</h2>
        ...
        <h2 class="col-span-4 font-semibold text-[24px] leading-none md:leading-tight text-[#00557B]">Detalle del reclamo del
        ...
        <div class="flex flex-row col-span-2 gap-2 ">
          <input type="submit" value="Enviar a libro de reclamaciones" id="btnAjax"
            class="col-span-4 text-white bg-[#00557B] py-3 rounded-2xl cursor-pointer border-2 font-semibold text-[16px] text-center border-none w-full md:w-auto px-10 inline-block" />
        </div>
